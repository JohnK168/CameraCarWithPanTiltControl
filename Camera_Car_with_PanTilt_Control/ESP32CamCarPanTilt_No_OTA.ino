...
{
  {12, 13,15}, //RIGHT_MOTOR Pins (EnA, IN1, IN2)// GPIO pin 12 is speed control 
  {12, 14, 2},  //LEFT_MOTOR  Pins (EnB, IN3, IN4) // GPIO pin 12 is speed control 
};
#define LIGHT_PIN 4
      ...
      <tr>
        ...
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="100" max="255" value="150" class="slider" id="Speed" oninput='sendButtonInput("Speed",value)'>
          </div>
        </td>
      </tr>        
      <tr>
